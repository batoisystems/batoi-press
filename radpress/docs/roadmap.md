...
Foundation runtime, public rendering, JSON config, HTML content loading, default theme, and status surfaces.
...
SEO, sitemap, RSS, cache controls, and static export.

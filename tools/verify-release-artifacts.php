...
function requiredEntries(): array
{
    return [
        ...
        'radpress/theme/default/assets/css/theme.css',
        'radpress/theme/default/assets/js/theme.js',
        'radpress/theme/default/layouts/landing.php',
        'radpress/theme/default/layouts/shop.php',
        'radpress/theme/default/layouts/product.php',
        'radpress/theme/default/layouts/cart.php',
        'radpress/theme/default/layouts/checkout.php',
        'radpress/theme/default/layouts/account.php',
        'radpress/theme/default/layouts/contact.php',
    ];
}
